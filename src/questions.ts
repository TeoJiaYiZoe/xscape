...
export const questions: Question[] = [
  {
    "question": "A cyberattack triggers an office lockdown, and the escape room timer starts. How do you unlock the first door?",
    "options": [
  ...
  {
    "question": "You find an encrypted message on the whiteboard. How do you decrypt it?",
    "options": [
  ...
  {
    "question": "The encrypted message leads to a locked drawer, but you're missing one number for the code. What now?",
    "options": [
  ...
  },
  {
    ...
    "question": "A computer displays riddles. Which one excites you most?",
    "options": [
  ...
  {
    "question": "The riddles are solved, but the countdown is ticking. What's your next move?",
    "options": [
  ...
  {
    "question": "After solving the riddles, the team debates the next move, suspecting hidden clues in the system. What’s your suggestion?",
    "options": [
  ...
  {
    "question": "The office phone rings with a taunting message. Is there a hidden clue? How do you react?",
    "options": [
  ...
  {
    "question": "Your colleague finds a locked safe with no key. What's your next move?",
    "options": [
  ...
  {
    "question": "Your colleague ask you to take a shortcut. What do you do?",
    "options": [
  ...
  {
    "question": "You escaped the room but still stuck in office! How do you stay focused amid the office distractions?",
    "options": [
  ...
  {
    "question": "You find an encrypted document in the printer. What’s your next move?",
    "options": [
  ...
  {
    "question": "The exit door is locked with a tricky puzzle. How do you solve it?",
    "options": [
  ...
  {
    "question": "Your teammate finds a hint but is struggling. How do you help?",
    "options": [
  ...
  {
    "question": "With just minutes left, what's your mindset to solve the final puzzle?",
    "options": [
